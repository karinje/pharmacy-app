...
function parseJSONResponse(response) {
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Failed to parse OpenAI response as JSON', { response, error });
    }
}
/**
...
exports.calculatePrescription = functions
    ...
    try {
        ...
        const optimizationPrompt = buildPackageOptimizerPrompt(data.drugName, totalQuantityNeeded, data.availablePackages.map((p) => ({
            ndc: p.ndc,
            size: p.packageSize,
