...
exports.searchDrugs = exports.normalizeDrugName = void 0;
 ...
 */
exports.normalizeDrugName = functions
    .region('us-central1')
    .runWith({
    timeoutSeconds: 30,
    memory: '256MB'
    ...
    if (!drugName || drugName.trim().length < 2) {
        throw new functions.https.HttpsError('invalid-argument', 'Drug name must be at least 2 characters');
    }
    try {
        ...
        if (!((_a = rxnormData.approximateGroup) === null || _a === void 0 ? void 0 : _a.candidate) ||
        ...
        const result = {
            ...
            alternatives: rxnormData.approximateGroup.candidate.slice(1, 5).map((c) => ({
                rxcui: c.rxcui,
                name: c.name,
                score: c.score
            }))
        ...
        try {
            ...
            if (ctssResponse.ok) {
                ...
                console.log('✅ CTSS RxTerms SUCCESS:', {
                    totalCount,
                    displayCount: (displayStrings === null || displayStrings === void 0 ? void 0 : displayStrings.length) || 0,
                    firstFew: displayStrings === null || displayStrings === void 0 ? void 0 : displayStrings.slice(0, 3),
                    hasExtras: !!extras,
                    hasRXCUIS: !!(extras === null || extras === void 0 ? void 0 : extras.RXCUIS)
                });
                if (displayStrings && displayStrings.length > 0) {
                    ...
                    candidates = displayStrings.map((displayArray, index) => {
                        var _a, _b;
                        ...
                        const rxcuis = ((_a = extras === null || extras === void 0 ? void 0 : extras.RXCUIS) === null || _a === void 0 ? void 0 : _a[index]) || [];
                        const sxdgRxcui = (_b = extras === null || extras === void 0 ? void 0 : extras.SXDG_RXCUI) === null || _b === void 0 ? void 0 : _b[index];
        ...
        if (candidates.length === 0) {
            ...
            if (response.ok) {
                ...
                console.log('RxNorm approximateTerm response:', {
                    hasCandidates: !!((_a = rxnormData.approximateGroup) === null || _a === void 0 ? void 0 : _a.candidate),
                    candidateCount: ((_c = (_b = rxnormData.approximateGroup) === null || _b === void 0 ? void 0 : _b.candidate) === null || _c === void 0 ? void 0 : _c.length) || 0
                });
                candidates = ((_d = rxnormData.approximateGroup) === null || _d === void 0 ? void 0 : _d.candidate) || [];
            }
            else {
